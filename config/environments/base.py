...
SECRET_KEY = "django-insecure-)1o(=sq(!efghy_#6ly)v_dctmmcvtxg(!+$d90^hs4k!*abn2"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("DB_NAME", "cbaas"),
        ...
        'OPTIONS': {
            'sslmode': os.environ.get("DB_SSLMODE", "prefer")  # strict in prod, relaxed in dev
        },
    }
}
