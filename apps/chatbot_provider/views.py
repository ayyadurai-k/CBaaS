...
from .serializers import ProviderSerializer, ProviderUpsertSerializer
...
class ChatbotProviderUpsertView(APIView):
    ...
    def put(self, request):
        ...
        bot, _ = Chatbot.objects.get_or_create(
            organization=org,
            defaults={"name": f"{org.name} Chatbot", "tone": "Technical", "system_instructions": ""},
        )
        ...
        if provider is None:
            provider = ChatbotProvider(chatbot=bot,
