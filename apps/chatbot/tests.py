...
class ChatbotModelTests(TestCase):
    ...
    def test_chatbot_creation(self):
        ...
        self.assertEqual(self.chatbot.system_instructions, self.chatbot_data["system_instructions"])
    ...
    def test_chatbot_defaults(self):
        ...
        minimal_bot = Chatbot.objects.create(
            organization=self.org,
            name="Minimal Bot"
        )
...
class ChatbotViewTests(APITestCase):
    ...
    def test_get_chatbot_success(self):
        ...
        self.assertEqual(response.data["system_instructions"], self.chatbot.system_instructions)
    ...
    def test_update_chatbot_success(self):
        ...
        self.assertEqual(response.data["system_instructions"], self.update_data["system_instructions"])
